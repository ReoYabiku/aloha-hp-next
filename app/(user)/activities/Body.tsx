    ...
    const activityDetails: ActivityProps[] = [
        {
            ...
            description:
                <>
                　2023年度の勉強合宿は開邦高校と昭和薬科大学附属高校の二校の生徒で、一泊二日に渡り開催されました。<br/>
                　テーマは「学びの相対化」と「非日常的な学びの探究」です。ハイレベルな仲間と共に自身の勉強への姿勢を相対化するとともに、暗記大会や両校教師の特別授業、東大生との座談会など、通常の学習環境では得られない体験ができました。
                </>,
